    ...
    <footer className="px-16 pt-16 pb-8" style={{ background: "var(--ink)" }}>
      ...
      >
        ...
        <div>
          ...
          >
            An open source community platform helping girls across India learn
            AI, find mentors, and build the future — for free.
          </p>
        </div>
      ...
      <div className="flex justify-between items-center">
        ...
        >
          © 2025 HerStack · Made with{" "}
          <span style={{ color: "var(--purple-mid)" }}>♥</span> for India's next
          generation of AI builders · Open Source
        </p>
        <div
